...
function Button(props) {
  return Button_jsx(external_react_["Fragment"], null, Button_jsx(external_styled_jsx_style_default.a, {
    id: "1406352712",
  ...
  }, [`button.__jsx-style-dynamic-selector{color:#000;border:none;outline:none;cursor:pointer;font-size:18px;font-weight:bold;padding:10px 20px;position:relative;border-radius:23px;-webkit-transition:.15s ease;transition:.15s ease;-webkit-transition-property:all;transition-property:all;background-color:#F8D57E;margin-${props.rtl ? "left" : "right"}:26px;${props.arrow && props.rtl ? "padding-left: 30px;" : ""} ${props.arrow && !props.rtl ? "padding-right: 30px;" : ""};}`, "button.__jsx-style-dynamic-selector:disabled{opacity:0.8;background:#e2e2e2;cursor:not-allowed;}", "button.__jsx-style-dynamic-selector:hover{-webkit-transform:scale(1.1);-ms-transform:scale(1.1);transform:scale(1.1);}", "button.__jsx-style-dynamic-selector:active{-webkit-transform:scale(0.98);-ms-transform:scale(0.98);transform:scale(0.98);}", "button.__jsx-style-dynamic-selector .tooltip.__jsx-style-dynamic-selector{left:28%;color:#fff;padding:6px;bottom:40px;display:none;font-size:13px;background:#000;position:absolute;border-radius:3px;}", "button.__jsx-style-dynamic-selector:hover .tooltip.__jsx-style-dynamic-selector{display:block;}", "button.__jsx-style-dynamic-selector div.arrow-up.__jsx-style-dynamic-selector{width:0;height:0;left:43%;bottom:-10px;position:absolute;border-top:5px solid black;border-left:5px solid transparent;border-right:5px solid transparent;}", `@media only screen and (max-width:400px){button.__jsx-style-dynamic-selector{width:100%;margin-bottom:13px;margin-${props.rtl ? "left" : "right"}:0px;}button.__jsx-style-dynamic-selector:hover{-webkit-transform:scale(1);-ms-transform:scale(1);transform:scale(1);}button.__jsx-style-dynamic-selector .tooltip.__jsx-style-dynamic-selector{left:36%;}}`]), Button_jsx("button", {
    type: props.type,
    onClick: props.onClick,
    disabled: props.disabled,
    className: external_styled_jsx_style_default.a.dynamic([["1406352712", [props.rtl ? "left" : "right", props.arrow && props.rtl ? "padding-left: 30px;" : "", props.arrow && !props.rtl ? "padding-right: 30px;" : "", props.rtl ? "left" : "right"]]]) + " " + (props.className || "")
  }, props.children, props.arrow && !props.rtl && Button_jsx("div", {
    className: external_styled_jsx_style_default.a.dynamic([["1406352712", [props.rtl ? "left" : "right", props.arrow && props.rtl ? "padding-left: 30px;" : "", props.arrow && !props.rtl ? "padding-right: 30px;" : "", props.rtl ? "left" : "right"]]]) + " " + "arrow-right"
  }), props.arrow && props.rtl && Button_jsx("div", {
    className: external_styled_jsx_style_default.a.dynamic([["1406352712", [props.rtl ? "left" : "right", props.arrow && props.rtl ? "padding-left: 30px;" : "", props.arrow && !props.rtl ? "padding-right: 30px;" : "", props.rtl ? "left" : "right"]]]) + " " + "arrow-left"
  }), props.tooltip && Button_jsx("div", {
    className: external_styled_jsx_style_default.a.dynamic([["1406352712", [props.rtl ? "left" : "right", props.arrow && props.rtl ? "padding-left: 30px;" : "", props.arrow && !props.rtl ? "padding-right: 30px;" : "", props.rtl ? "left" : "right"]]]) + " " + "tooltip"
  }, props.tooltip, Button_jsx("div", {
    style: {
      position: "relative"
    },
    className: external_styled_jsx_style_default.a.dynamic([["1406352712", [props.rtl ? "left" : "right", props.arrow && props.rtl ? "padding-left: 30px;" : "", props.arrow && !props.rtl ? "padding-right: 30px;" : "", props.rtl ? "left" : "right"]]])
  }, Button_jsx("div", {
    className: external_styled_jsx_style_default.a.dynamic([["1406352712", [props.rtl ? "left" : "right", props.arrow && props.rtl ? "padding-left: 30px;" : "", props.arrow && !props.rtl ? "padding-right: 30px;" : "", props.rtl ? "left" : "right"]]]) + " " + "arrow-up"
  })))));
}
...
function NewsletterForm(props) {
  ...
  }, [`p.small.__jsx-style-dynamic-selector{font-size:15px;margin:0;margin-top:7.5px;text-align:${props.rtl ? "right" : "left"};color:#111;}`]), NewsletterForm_jsx("form", {
    onSubmit: handleSubmit,
    className: external_styled_jsx_style_default.a.dynamic([["2804353344", [props.rtl ? "right" : "left"]]]) + " " + "newsletter"
  }, NewsletterForm_jsx(Input, {
    type: "email",
    rtl: props.rtl,
    value: value,
    onChange: handleChange,
    label: strings[props.rtl ? "hebrew" : "english"].Common.EmailAddressPlaceholder
  }), NewsletterForm_jsx(components_Button, {
    rtl: props.rtl,
    arrow: true
  }, strings[props.rtl ? "hebrew" : "english"].Common[props.buttonText || "SignUp"]), props.subtitle && NewsletterForm_jsx("p", {
    className: external_styled_jsx_style_default.a.dynamic([["2804353344", [props.rtl ? "right" : "left"]]]) + " " + "small"
...
/* harmony default export */ var SignaturePad = (props => {
  ...
  return SignaturePad_jsx(external_react_["Fragment"], null, SignaturePad_jsx(external_styled_jsx_style_default.a, {
    ...
    type: "button",
    className: "jsx-2057520806"
  }, strings[props.language].Common.Reset)));
});
...
/* harmony default export */ var LeumiForm = (props => {
  ...
  return LeumiForm_jsx(external_react_["Fragment"], null, LeumiForm_jsx("form", {
    ...
    arrow: true
  }, strings[props.language].Common.Download), LeumiForm_jsx(components_Button, {
    rtl: props.language === "hebrew" ? true : false,
    onClick: () => setStep(5),
    arrow: true
  }, strings[props.language].Common.StayUpToDate))), step === 5 && LeumiForm_jsx(external_react_["Fragment"], null, LeumiForm_jsx("h1", {
    className: "mb-2"
  }, strings[props.language].Forms.StayUpToDate.title), LeumiForm_jsx("h2", {
    className: "mb-2"
  }, strings[props.language].Forms.StayUpToDate.subtitle), LeumiForm_jsx(components_NewsletterForm, {
...
/* harmony default export */ var _app = __webpack_exports__["default"] = (() => {
  ...
  return language && _app_jsx("div", {
    className: language
  }, _app_jsx(external_react_grid_system_["Container"], null, _app_jsx(head_default.a, null, _app_jsx("title", null, "CoronaForms")), _app_jsx(external_react_grid_system_["Row"], {
    className: "header"
