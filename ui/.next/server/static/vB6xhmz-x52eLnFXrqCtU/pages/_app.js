...
/* harmony default export */ var Input = (props => {
  ...
  return Input_jsx(external_react_["Fragment"], null, Input_jsx(external_styled_jsx_style_default.a, {
    ...
    className: external_styled_jsx_style_default.a.dynamic([["1611414408", [props.rtl ? "right" : "left", props.rtl ? "right" : "left", props.rtl ? "rtl" : "ltr"]]]) + " " + (["input-field", focus ? "focus" : ""].join(" ") || "")
  }, Input_jsx("label", {
    onClick: handleLabelClick,
    className: external_styled_jsx_style_default.a.dynamic([["1611414408", [props.rtl ? "right" : "left", props.rtl ? "right" : "left", props.rtl ? "rtl" : "ltr"]]])
...
/* harmony default export */ var LeumiForm = (props => {
  ...
  return LeumiForm_jsx(external_react_["Fragment"], null, LeumiForm_jsx("form", {
    ...
    className: "mt-2",
    arrow: true
  }, strings[props.language].Common.PreviewRequest)));
});
...
/* harmony default export */ var _app = __webpack_exports__["default"] = (() => {
  ...
  const {
    0: language,
    1: setLanguage
  } = Object(external_react_["useState"])("hebrew");
  ...
  return _app_jsx("div", {
    ...
    arrow: true
  }, strings[language].Common.Jerusalem)), step === "bank_form" && _app_jsx(external_react_["Fragment"], null, data.bank === "leumi" && _app_jsx(LeumiForm, {
    language: language,
    data: data,
    ...
    className: "floor"
  }), _app_jsx(external_react_grid_system_["Container"], null, _app_jsx("div", {
    className: "mb-1 pt-1"
  }, "CoronaForms.org ", new Date().getFullYear()), _app_jsx("div", {
    className: "mb-1"
  }, strings[language].Footer.MadeWithLoveInIsrael)), _app_jsx("div", {
    style: {
      background: "#000",
      height: 20
    }
